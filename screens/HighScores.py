...
class HighScores(Game):
    ...
    def draw(self):
        ...
        utils.drawText(Vector2(40, 10), "Top 7 high scores",
        ...
        for score in self.scores:
            pygame.draw.rect(utils.display, (233, 233, 233),
                             (x - 10, y - 5,  150, 20), 1)
            pygame.draw.rect(utils.display, (233, 233, 233),
                             (x - 10, y - 5, 50, 20), 1)

            utils.drawText(Vector2(x + 15, y), str(i),
                           (233, 233, 233), utils.font8)
            utils.drawText(Vector2(x + 80, y), str(score),
                           (233, 233, 233), utils.font8)
            y += 22
            i += 1
